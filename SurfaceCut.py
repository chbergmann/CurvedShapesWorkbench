...
class SurfaceCut:
    def __init__(self, obj, Surfaces=[], Normal=Vector(0, 0, 1), Position=0, Face=False, Simplify=0): 
        obj.addProperty("App::PropertyLinkList", "Surfaces", "SurfaceCut", QT_TRANSLATE_NOOP("App::Property", "List of objects with a surface")).Surfaces = Surfaces
        obj.addProperty("App::PropertyVector", "Normal", "SurfaceCut", QT_TRANSLATE_NOOP("App::Property", "Normal vector of the cut plane")).Normal = Normal
        obj.addProperty("App::PropertyVector", "Position", "SurfaceCut", QT_TRANSLATE_NOOP("App::Property", "Position of the cut plane relative to Surfaces")).Position = Position
        obj.addProperty("App::PropertyBool", "Face", "SurfaceCut", QT_TRANSLATE_NOOP("App::Property", "make a face")).Face = Face
        obj.addProperty("App::PropertyQuantity", "Simplify", "SurfaceCut", QT_TRANSLATE_NOOP("App::Property", "if >0, discretize each edge to this number of poles and approximate.")).Simplify = Simplify
        self.update = True
        obj.Proxy = self  
    ...
    class SurfaceCutCommand():
        ...
        def GetResources(self):
            return {'Pixmap'  : os.path.join(CurvedShapes.get_module_path(), "Resources", "icons", "surfaceCut.svg"),
                    ...
                    'MenuText': QT_TRANSLATE_NOOP("SurfaceCut", "Surface Cut"),
                    'ToolTip' : QT_TRANSLATE_NOOP("SurfaceCut", __doc__)}
